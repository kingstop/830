...
{
    msgs2s::MsgGT2GSOfflineUser msg;
    msg.set_trans(t);
    sendPBMessage(&msg);
...
{
	msgs2s::MsgDB2GTChangeGS* msg = static_cast<msgs2s::MsgDB2GTChangeGS*>(p);
	UserSession* pksession = gGTUserMgr.getUserSession(flag);
...
{
    msgs2s::MsgGS2GTOnlines* msg = static_cast<msgs2s::MsgGS2GTOnlines*>(p);
    if (msg)
    {
...
void GateGameClient::initPBModule()
{
    ...
    ProtocMsgBase<GateGameClient>::registerCBFun(PROTOCO_NAME(msgs2s::MsgServerRegister),   &GateGameClient::parseGameRegister);
    ProtocMsgBase<GateGameClient>::registerCBFun(PROTOCO_NAME(msgs2s::MsgGS2GTOnlines),     &GateGameClient::parseGameOnlines);
	ProtocMsgBase<GateGameClient>::registerCBFun(PROTOCO_NAME(msgs2s::MsgDB2GTChangeGS),     &GateGameClient::parseChangeGS);
